...
// Thu Oct  6 11:11:00 2022 by ROOT version 6.24/07
// from TTree Delphes/Analysis tree
// found on file: mytest1a.root
//////////////////////////////////////////////////////////
...
#ifdef dump_gen1_cxx
dump_gen1::dump_gen1(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("mytest1a.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("mytest1a.root");
      }
...
Int_t dump_gen1::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t dump_gen1::LoadTree(Long64_t entry)
{
...
void dump_gen1::Init(TTree *tree)
{
...
void dump_gen1::Show(Long64_t entry)
{
...
Int_t dump_gen1::Cut(Long64_t entry)
{
