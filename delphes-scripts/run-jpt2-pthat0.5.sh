...
export LD_LIBRARY_PATH=/home/owen/root-build-6.24/root_install/lib:/home/owen/pythia/pythia8307/lib/
  ...
  #export delphes_config=simple_star_forward_cal_config_jpt3.0.tcl
   ...
   export delphes_config=simple_star_forward_cal_config_rec_jpt2.0_gen_jpt1.0.tcl

  #----------------

  #export pythia_config=pythia_RHIC_test_pthat0.5_1Mevts.cmnd
   export pythia_config=pythia_RHIC_test_pthat0.5_10Mevts.cmnd

  #export pythia_config=pythia_RHIC_test_1Mevts.cmnd
