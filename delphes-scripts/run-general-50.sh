...
export LD_LIBRARY_PATH=/home/owen/root-build-6.24/root_install/lib:/home/owen/pythia/pythia8307/lib/
  ...
  nohup   ./DelphesPythia8        $delphes_config        $pythia_config   current-output/chunk-30.root     >&     current-output/chunk-30.log &
  sleep 2
  nohup   ./DelphesPythia8        $delphes_config        $pythia_config   current-output/chunk-31.root     >&     current-output/chunk-31.log &
  sleep 2
  nohup   ./DelphesPythia8        $delphes_config        $pythia_config   current-output/chunk-32.root     >&     current-output/chunk-32.log &
  sleep 2
  nohup   ./DelphesPythia8        $delphes_config        $pythia_config   current-output/chunk-33.root     >&     current-output/chunk-33.log &
  sleep 2
  nohup   ./DelphesPythia8        $delphes_config        $pythia_config   current-output/chunk-34.root     >&     current-output/chunk-34.log &
  sleep 2
  nohup   ./DelphesPythia8        $delphes_config        $pythia_config   current-output/chunk-35.root     >&     current-output/chunk-35.log &
  sleep 2
  nohup   ./DelphesPythia8        $delphes_config        $pythia_config   current-output/chunk-36.root     >&     current-output/chunk-36.log &
  sleep 2
  nohup   ./DelphesPythia8        $delphes_config        $pythia_config   current-output/chunk-37.root     >&     current-output/chunk-37.log &
  sleep 2
  nohup   ./DelphesPythia8        $delphes_config        $pythia_config   current-output/chunk-38.root     >&     current-output/chunk-38.log &
  sleep 2
  nohup   ./DelphesPythia8        $delphes_config        $pythia_config   current-output/chunk-39.root     >&     current-output/chunk-39.log &


  nohup   ./DelphesPythia8        $delphes_config        $pythia_config   current-output/chunk-40.root     >&     current-output/chunk-40.log &
  sleep 2
  nohup   ./DelphesPythia8        $delphes_config        $pythia_config   current-output/chunk-41.root     >&     current-output/chunk-41.log &
  sleep 2
  nohup   ./DelphesPythia8        $delphes_config        $pythia_config   current-output/chunk-42.root     >&     current-output/chunk-42.log &
  sleep 2
  nohup   ./DelphesPythia8        $delphes_config        $pythia_config   current-output/chunk-43.root     >&     current-output/chunk-43.log &
  sleep 2
  nohup   ./DelphesPythia8        $delphes_config        $pythia_config   current-output/chunk-44.root     >&     current-output/chunk-44.log &
  sleep 2
  nohup   ./DelphesPythia8        $delphes_config        $pythia_config   current-output/chunk-45.root     >&     current-output/chunk-45.log &
  sleep 2
  nohup   ./DelphesPythia8        $delphes_config        $pythia_config   current-output/chunk-46.root     >&     current-output/chunk-46.log &
  sleep 2
  nohup   ./DelphesPythia8        $delphes_config        $pythia_config   current-output/chunk-47.root     >&     current-output/chunk-47.log &
  sleep 2
  nohup   ./DelphesPythia8        $delphes_config        $pythia_config   current-output/chunk-48.root     >&     current-output/chunk-48.log &
  sleep 2
  nohup   ./DelphesPythia8        $delphes_config        $pythia_config   current-output/chunk-49.root     >&     current-output/chunk-49.log &
