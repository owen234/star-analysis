...
#include "utils.c"
   ...
   void pf_jet_eta( int sel = 0, const char* infile = "ca4-output/all.root" ) {
      ...
      sprintf( fname, "pf_jet1eta_vs_jet0eta_sel%d_2d.pdf", sel ) ;
      can1 -> SaveAs( fname ) ;
    ...
    //---------------
      ...
      sprintf( fname, "pf_jet1eta_vs_jet0eta_sel%d_1d.pdf", sel ) ;
      can1 -> SaveAs( fname ) ;
