...
#ifndef event_display2_h
#define event_display2_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   event_display2(TTree *tree=0);
   virtual ~event_display2();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop( int first_evt=0, bool big_canvas = true );
...
#ifdef event_display2_cxx
event_display2::event_display2(TTree *tree) : fChain(0) 
{
...
event_display2::~event_display2()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t event_display2::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t event_display2::LoadTree(Long64_t entry)
{
...
void event_display2::Init(TTree *tree)
{
...
void event_display2::Show(Long64_t entry)
{
...
Int_t event_display2::Cut(Long64_t entry)
{
...
#endif // #ifdef event_display2_cxx
