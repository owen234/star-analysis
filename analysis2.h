...
// Fri Oct  7 09:36:56 2022 by ROOT version 6.24/07
// from TTree Delphes/Analysis tree
// found on file: us-test1a.root
//////////////////////////////////////////////////////////
...
#ifdef analysis2_cxx
analysis2::analysis2(TTree *tree) : fChain(0) 
{

   //TFile* f = new TFile("us-ngp-test1b.root");
   //TFile* f = new TFile("us-ngp-soft-test1a.root");
   TFile* f = new TFile("us-ngp-test2a-10m.root");
