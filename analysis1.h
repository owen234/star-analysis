...
// Fri Oct  7 09:25:22 2022 by ROOT version 6.24/07
// from TTree Delphes/Analysis tree
// found on file: mytest-rhic-3a.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 605;
   static constexpr Int_t kMaxTrack = 28;
   static constexpr Int_t kMaxTower = 27;
   static constexpr Int_t kMaxEFlowTrack = 28;
   static constexpr Int_t kMaxEFlowPhoton = 16;
   static constexpr Int_t kMaxEFlowNeutralHadron = 20;
   ...
   Double_t        GenJet_ExclYmerge12[kMaxGenJet];   //[GenJet_]
   ...
   Double_t        FatJet_ExclYmerge12[kMaxFatJet];   //[FatJet_]
...
#ifdef analysis1_cxx
analysis1::analysis1(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("mytest-rhic-3a.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("mytest-rhic-3a.root");
      }
...
Int_t analysis1::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t analysis1::LoadTree(Long64_t entry)
{
...
void analysis1::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("GenJet.ExclYmerge12", &GenJet_ExclYmerge12, &b_GenJet_ExclYmerge12);
   ...
   fChain->SetBranchAddress("FatJet.ExclYmerge12", &FatJet_ExclYmerge12, &b_FatJet_ExclYmerge12);
...
void analysis1::Show(Long64_t entry)
{
...
Int_t analysis1::Cut(Long64_t entry)
{
